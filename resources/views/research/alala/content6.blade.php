...
<pre class="arabic">تَعَـــلَّمْ فَلَيْسَ الْمَرْءُ يوْلَدُ عَالِمًــــا ۞ وَلَيْسَ أَخُوْ عِلْمٍ كَمَنْ هُوَ جَاهِلُ
</pre>
NGAJIO ILMU SIRO KRONO DAK NO WONG SIJI
IKU DEN ANA'AKE KANTHI UWIS MANGERTI
...
<pre class="arabic">تَغَرَّبْ عَنِ اْلاَوْطَانِ فِى طَلَبِ الْعُلىَ ۞ وَسَـافِرْ فَفِى اْلاَسْفَارِ خَمْسُ فَوَائِـدِ
</pre>
...
<pre class="arabic">تَفَــرُّجُ هَــمٍّ وَاكْتِسَـابِ مَعِيْشَــةٍ ۞ وَعِلـــمٌ وَآدَابٌ وَ صُحْبَــةُ مَــاجِدِ
</pre>
...
<pre class="arabic">وَاِنْ قِيْـلَ فِى اْلاَسْفَـارِ ذُلٌّ وَغُرْبَــهٌ ۞ وَ قَطْـعُ فَيَـافٍ وَ ارْتِكَابُ شَـــدَائِدَ
</pre>
NAJAN ONO ING LUNGAN NGROSO INO NGUMBORO
LAN JUNGKUNG ORO-ORO LAN NGLAKONI SENGSORO
<br/>
...
<pre class="arabic">فَمَوْتُ الْفَتَى خَيْرٌ لَهُ مِنْ حَيَاتِهِ ۞ بِدَارِ هَوَانٍ بَيْنَ وَاشٍ وَحَـــاسِدٍ
</pre>
MATINE WONG NOM LUWIH APIK TIMBANG URIPE
ING DESO KUMPUL WONG KANG ADU-ADU LAN DRENGKI
<br/>
